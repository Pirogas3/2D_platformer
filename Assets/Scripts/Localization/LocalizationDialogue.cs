namespace SheetXExample
{
	...
	public static class LocalizationDialogue
	{
		public enum ID 
		{
			NONE = -1,
			SharkyNPC_1 = 0, SharkyNPC_2, SharkyNPC_3, Capitan_Help1, Capitan_Help2, Capitan_Help3, Capitan_Help4, Capitan_Help5, Capitan_Help6, Capitan_Help7, Capitan_Warning1, Capitan_Warning2, Capitan_Warning3, Capitan_Warning4, Capitan_Warning5, Capitan_Danger1, Capitan_Hint1, Capitan_Hint2, Capitan_Hint3, Capitan_Hint4, Capitan_UsePotion1, Capitan_UsePotion2, Capitan_UsePotion3, NeedAKey_Door, NeedAKey_Chest, NoTurningBack, EndGame1, EndGame2, EndGame3, EndGame4,
		}
		public const int
			SharkyNPC_1 = 0, SharkyNPC_2 = 1, SharkyNPC_3 = 2, Capitan_Help1 = 3, Capitan_Help2 = 4, Capitan_Help3 = 5, Capitan_Help4 = 6, Capitan_Help5 = 7, Capitan_Help6 = 8, Capitan_Help7 = 9, Capitan_Warning1 = 10, Capitan_Warning2 = 11, Capitan_Warning3 = 12, Capitan_Warning4 = 13, Capitan_Warning5 = 14, Capitan_Danger1 = 15, Capitan_Hint1 = 16, Capitan_Hint2 = 17, Capitan_Hint3 = 18, Capitan_Hint4 = 19, Capitan_UsePotion1 = 20, Capitan_UsePotion2 = 21, Capitan_UsePotion3 = 22, NeedAKey_Door = 23, NeedAKey_Chest = 24, NoTurningBack = 25, EndGame1 = 26, EndGame2 = 27, EndGame3 = 28, EndGame4 = 29;
		public static readonly string[] idString = new string[]
		{
			"SharkyNPC_1", "SharkyNPC_2", "SharkyNPC_3", "Capitan_Help1", "Capitan_Help2", "Capitan_Help3", "Capitan_Help4", "Capitan_Help5", "Capitan_Help6", "Capitan_Help7", "Capitan_Warning1", "Capitan_Warning2", "Capitan_Warning3", "Capitan_Warning4", "Capitan_Warning5", "Capitan_Danger1", "Capitan_Hint1", "Capitan_Hint2", "Capitan_Hint3", "Capitan_Hint4", "Capitan_UsePotion1", "Capitan_UsePotion2", "Capitan_UsePotion3", "NeedAKey_Door", "NeedAKey_Chest", "NoTurningBack", "EndGame1", "EndGame2", "EndGame3", "EndGame4",
		};
		public static readonly Dictionary<string, string> LanguageFiles = new Dictionary<string, string>() {  { "english", "LocalizationDialogue_english" }, { "russian", "LocalizationDialogue_russian" }, };
	    ...
	    public static async void Init()
		{
			...
			{
	#if UNITY_EDITOR
				Debug.Log($"Init {nameof(LocalizationDialogue)}");
	#endif
	    ...
	    /// <summary>
	    /// Used this if you are unable to add LocalizationDialogueText component to the gameObject
	    /// </summary>
	...
	#if UNITY_EDITOR
	        if (pObj.TryGetComponent(out LocalizationDialogueText _))
	            Debug.LogError($"{pObj.name} should not have LocalizationDialogueText!");
	#endif
	    }
		...
		private static void CreateClassContainsRefinedIds(string pPath)
		{
			...
			Debug.Log($"{ids.Count} ids of LocalizationDialogue has been used, The info at path {pPath}");
		...
		{
			var components = obj.GetComponentsInChildren<LocalizationDialogueText>(true);
		...
		private static void CreateClassContainsRefinedIds(List<string> pRefinedIds)
		{
			...
			{
				enumIds += $"{nameof(LocalizationDialogue)}.ID.{pRefinedIds[i]}";
				intIds += $"{nameof(LocalizationDialogue)}.{pRefinedIds[i]}";
			...
			var path = $"{directoryPath}/{nameof(LocalizationDialogue)}RefinedIds.cs";
			System.IO.File.WriteAllText(path, result);
			Debug.Log($"Created {path}");
		}
		private static string GetTemplateClassContainsRefinedIds()
		{
			string @namespace = typeof(LocalizationDialogue).Namespace + "abc";
			string className = "LocalizationDialogueRefinedIds";
			string enumField = "public static readonly List<LocalizationDialogue.ID> enumIds = new List<LocalizationDialogue.ID> { ENUM_IDS };";
			...
			string content = $"using System.Collections.Generic;{Environment.NewLine}"
				+ "// This script refines the IDs of LocalizationDialogue used in any prefab within the project. It searches all prefabs containing the LocalizationDialogue component and retrieves the localized ids."
		...
		[MenuItem("Assets/Create/LocalizationX/Refine LocalizationDialogue Ids")]
